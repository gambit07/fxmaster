...
/**
 * A full-screen particle effect which renders drifting fishs.
 */
export class FishsParticleEffect extends FXMasterParticleEffect {
  /** @override */
  static label = "FXMASTER.Particles.Effects.Fishs";

  /** @override */
  static get icon() {
    return "modules/fxmaster/assets/particle-effects/icons/fishs.webp";
  }
  ...
  /**
   * Configuration for the particle emitter for drifting fishs
  ...
  static FISHS_CONFIG = {
    ...
    behaviors: [
      ...
      },
      {
        type: "textureRandom",
        config: {
          textures: Array.fromRange(12).map(
            (n) => `modules/fxmaster/assets/particle-effects/effects/fishs/fish${n + 1}.png`,
          ),
        },
      },
      {
  ...
  getParticleEmitters(options = {}) {
    ...
    const config = foundry.utils.deepClone(this.constructor.FISHS_CONFIG);
